...
export function HealthLogsScreen({ navigation }: HealthLogsScreenProps) {
  ...
  const tabs = ['All', 'Vitals', 'Meds', 'Meals', 'Mood', 'Symptoms', 'Activity'];
  ...
  const logEntries: LogEntry[] = [
    ...
    },
    {
      ...
      details: {
        'medications: Lisinopril 10mg, Metformin 500mg': 'Lisinopril 10mg, Metformin 500mg',
      },
    },
    {
      id: 4,
  ...
  return (
    <View style={styles.container}>
      ...
      >
          ...
          <View style={styles.summaryRow}>
            <View style={styles.summaryCard}>
              <View style={[styles.summaryIcon, { backgroundColor: '#E8F5E9' }]}>
                <Ionicons name="restaurant-outline" size={20} color="#66BB6A" />
              </View>
            ...
            <View style={styles.summaryCard}>
              <View style={[styles.summaryIcon, { backgroundColor: '#FFF3E0' }]}>
                <Ionicons name="happy-outline" size={20} color="#FFA726" />
              </View>
        ...
        <View style={styles.logsContainer}>
          {logEntries.map((entry) => (
            <TouchableOpacity
              accessibilityLabel={`${entry.title} log entry`}
              key={entry.id}
            ...
            >
              <View style={styles.logHeader}>
                <View style={[styles.logIcon, { backgroundColor: entry.iconBg }]}>
                  <Ionicons color={entry.iconColor} name={entry.icon} size={20} />
                </View>
                <View style={styles.logContent}>
                  <Text style={styles.logTitle}>{entry.title}</Text>
                  {entry.note && <Text style={styles.logNote}>{entry.note}</Text>}
                  <View style={styles.logMeta}>
                    <View style={[styles.tag, { backgroundColor: entry.tagColor }]}>
      ...
      <TouchableOpacity
        accessibilityLabel="Add new health log"
